                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">#Plans ID</th>
                            <th scope="col" class="px-4 py-3">Payment Date</th>
                            <th scope="col" class="px-4 py-3">Monthly Installment Amount</th>
                            <th scope="col" class="px-4 py-3">Penalty Amount</th>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" id="payments_form">
                <div class="grid gap-4 mb-4 grid-cols-2">
                     ...
                     {{-- Installment ID --}}
                     <div class="col-span-2">
                        <label for="plans_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Plans ID</label>
                        <select id="plans_id" name="plans_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            
                            {{-- Ajax Show all the ID and Amount --}}
